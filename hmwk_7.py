...
'''9-2. Start with your class from Exercise 9-1. Create three 
...
'''9-3. Make a class called User. Create two attributes 
...
'''9-4. Start with your program from Exercise 9-1 (page 166). Add an attribute 
called number_served with a default value of 0. Create an instance called restaurant
 from this class. Print the number of customers the restaurant has served, and then 
...
'''9-5. Add an attribute called login_attempts to your 
User class from Exercise 9-3 (page 166). Write amehtod
 called increment_login_attempts() that increments the 
...
'''9-6. An ice cream stand is a specific kind of restaurant. Write a class called 
IceCreamStand that inherits from the Restaurant class you wrote in Exercise 9-1 
(page 166) or Exercise 9-4 (page 171). Eitehr version of the class will work; just
 pick the one you like better. Add an attribute called flavors that stores a list
  of ice cream flavors. Write a method that displays theese flavors. Create an instance of IceCreamStand, and call this method.'''
...
'''9-7. An administrator is a special kind of user. Write a class
...
'''9-8. Write a separate Privileges class.
 The class should have one attribute, privileges, that stores a 
 list of strings as described in Exercise 9-7. Move the 
...
'''9-9. Use the final version of electric_car.py 
from this section. Add a method to the Battery class
 called upgrade_battery(). This method should check the 
 battery size and set the capacity to 85 if it isn’t already.
...
'''9-10. Using your latest Restaurant class, store it in a 
module. Make a separate file that imports Restaurant. Make a
 Restaurant instance, and call one of Restaurant’s methods 
...
'''9-11. Start with your work from Exercise 9-8 (page 178). 
...
'''9-12. Store the User class in one module, and store the 
Privileges and Admin classes in a separate module. In a separate 
...
'''9-13. Start with Exercise 6-4 (page 108), where you used a standard
...
'''9-14. The module random contains functions that generate random 
numbers in a variety of ways. The function randint() returns an integer 
in the range you provide. the following code returns a number between 1 and 6:'''
